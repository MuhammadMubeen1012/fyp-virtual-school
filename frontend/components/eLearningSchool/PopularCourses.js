                ...
                <div className="row">
                    ...
                    <div className="col-lg-12 col-md-12">
                        <div className="courses-info">
                            <p>Enjoy the top notch learning methods and achieve next level skills! You are the creator of your own career & we will guide you through that. <Link href="/login"><a>Register Free Now!</a></Link>.</p>
                        </div>
                    </div>
                </div>
            </div>
